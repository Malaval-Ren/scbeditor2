...
class MyScbPalletWindow:
    ...
    # ####################### __scbw_select_color_rad_btn ########################
    def __scbw_select_color_rad_btn( self, i_offset):
    ...
    # ####################### __scbw_import_block ########################
    def __scbw_import_block( self, a_image):
        ...
        self.__scbw_select_color_rad_btn( 0)
    ...
    def scbw_create_scb_window( self, a_pallet_image, a_work_img, i_selected_pallet_in_main_windows):
        ...
        if a_pallet_image and a_work_img:
            ...
            self.__scbw_import_block( a_pallet_image)
            self.w_import_window.update()
