...
# sudo apt-get install ./scbeditor2_2.1.8-25_amd64.deb
#
# How to uninstall package
# sudo apt-get remove ./scbeditor2_2.1.8-25_amd64.deb
...
# if problem
# sudo dpkg -i ./scbeditor2_2.1.8-25_amd64.deb
...
then
	...
	sudo chown renaud:renaud -R "$packageSrcBase"
	sudo chown renaud:renaud ./scbeditor2_2.1.8-25_amd64.deb
	sudo chown renaud:renaud ./scbeditor2-2.1.8-25.x86_64.rpm
	echo
