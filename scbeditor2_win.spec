...
a = Analysis(
    ...
    runtime_hooks=[],
    excludes=[
        'altgraph', 'astroid', 'autocommand',
        'colorama', 'contourpy', 'cycler',
        'dill', 'fonttools', 'gitdb',
        'GitPython', 'isort', 'jaraco.context',
        'jaraco.functools', 'jaraco.text',
        'kiwisolver', 'matplotlib', 'mccabe',
        'more-itertools', 'numpy', 'packaging',
        'pefile', 'pip', 'platformdirs',
        'Pmw', 'pycodestyle', 'pyinstaller',
        'pyinstaller-hooks-contrib', 'pylint',
        'pymodbus', 'pyparsing',
        'pypi', 'pypiwin32', 'python-dateutil',
        'pythonping', 'pywin32', 'pywin32-ctypes',
        'setuptools', 'six', 'smmap',
        'tomlkit', 'ttkthemes', 'ttkwidgets'
    ],
